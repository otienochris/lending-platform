...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final OrchestratorConfigsProperties properties;
    ...
    private String getPrincipalClaimName(Jwt jwt) {
        ...
        String principalAttribute = properties.getServiceProperties().getOrchestratorProperties().getSecurityConfigSpec().getJwtSpec().getPrincipalAttribute();
    ...
    private Collection<? extends GrantedAuthority> extractedResourceRoles(Jwt jwt) {
        ...
        String resourceId = properties.getServiceProperties().getOrchestratorProperties().getSecurityConfigSpec().getJwtSpec().getResourceId();
