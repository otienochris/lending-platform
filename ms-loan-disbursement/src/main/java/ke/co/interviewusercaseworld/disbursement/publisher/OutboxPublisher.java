package ke.co.interviewusercaseworld.disbursement.publisher;

import ke.co.interviewusercaseworld.commons.enums.CommandsEnum;
import ke.co.interviewusercaseworld.commons.enums.LogLevelEnum;
import ke.co.interviewusercaseworld.commons.enums.OperationNameEnum;
import ke.co.interviewusercaseworld.commons.utils.Helpers;
import ke.co.interviewusercaseworld.disbursement.configs.DisbursementConfigsProperties;
    ...
    public void publishOutboxEvent(){
        ...
        outboxRepo.findTop20ByIsPublishedFalse()
                .flatMap(outBoxEvent -> {
                    ...
                    String topic = appProperties.getServiceProperties().getLoanDisbursementProperties().getKafkaConfigs().getTopicsForCommand().getOrDefault(commandsEnum, "");
