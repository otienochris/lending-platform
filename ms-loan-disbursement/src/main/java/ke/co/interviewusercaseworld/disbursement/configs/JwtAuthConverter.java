...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final DisbursementConfigsProperties properties;
    ...
    private String getPrincipalClaimName(Jwt jwt) {
        ...
        String principalAttribute = properties.getServiceProperties().getLoanDisbursementProperties().getSecurityConfigSpec().getJwtSpec().getPrincipalAttribute();
    ...
    private Collection<? extends GrantedAuthority> extractedResourceRoles(Jwt jwt) {
        ...
        String resourceId = properties.getServiceProperties().getLoanDisbursementProperties().getSecurityConfigSpec().getJwtSpec().getResourceId();
