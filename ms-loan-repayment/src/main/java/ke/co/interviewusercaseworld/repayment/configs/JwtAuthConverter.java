...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final RepaymentConfigsProperties properties;
    ...
    private String getPrincipalClaimName(Jwt jwt) {
        ...
        String principalAttribute = properties.getServiceProperties().getLoanRepaymentProperties().getSecurityConfigSpec().getJwtSpec().getPrincipalAttribute();
    ...
    private Collection<? extends GrantedAuthority> extractedResourceRoles(Jwt jwt) {
        ...
        String resourceId = properties.getServiceProperties().getLoanRepaymentProperties().getSecurityConfigSpec().getJwtSpec().getResourceId();
