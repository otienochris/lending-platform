package ke.co.expd.authserver.publisher;

import ke.co.expd.authserver.config.AuthConfigsProperties;
...
public class OutboxPublisher {
    ...
    private final AuthConfigsProperties appProperties;
    ...
    public void publishOutboxEvent(){
        ...
        outboxRepo.findTop20ByIsPublishedFalse()
                .flatMap(outBoxEvent -> {
                    ...
                    String topic = appProperties.getServiceProperties().getAuthServerProperties().getKafkaConfigs().getTopicsForCommand().getOrDefault(commandsEnum, "");
