...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final NotificationConfigsProperties properties;
    ...
    private String getPrincipalClaimName(Jwt jwt) {
        ...
        String principalAttribute = properties.getServiceProperties().getNotificationProperties().getSecurityConfigSpec().getJwtSpec().getPrincipalAttribute();
    ...
    private Collection<? extends GrantedAuthority> extractedResourceRoles(Jwt jwt) {
        ...
        String resourceId = properties.getServiceProperties().getNotificationProperties().getSecurityConfigSpec().getJwtSpec().getResourceId();
