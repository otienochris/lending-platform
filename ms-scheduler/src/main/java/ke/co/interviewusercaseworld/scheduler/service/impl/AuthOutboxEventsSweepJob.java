...
import ke.co.interviewusercaseworld.scheduler.repository.AuthOutBoxEventRepository;
...
public class AuthOutboxEventsSweepJob implements SweepJob {
    ...
    @Override
    @Job(name = "Auth Outbox Events", retries = 3)
    ...
    private Mono<AuthOutboxEvent> markAsPublished(String refID, AuthOutboxEvent e) {
