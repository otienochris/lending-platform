...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final SchedulerConfigsProperties properties;
    ...
    private String getPrincipalClaimName(Jwt jwt) {
        ...
        String principalAttribute = properties.getServiceProperties().getSchedulerProperties().getSecurityConfigSpec().getJwtSpec().getPrincipalAttribute();
    ...
    private Collection<? extends GrantedAuthority> extractedResourceRoles(Jwt jwt) {
        ...
        String resourceId = properties.getServiceProperties().getSchedulerProperties().getSecurityConfigSpec().getJwtSpec().getResourceId();
