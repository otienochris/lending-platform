...
import ke.co.interviewusercaseworld.scheduler.repository.OrchestratorOutBoxEventRepository;
...
public class OrchestratorOutboxEventsSweepJob implements SweepJob {


    private final OrchestratorOutBoxEventRepository outboxEventRepository;
    ...
    @Override
    @Job(name = "orchestrator Outbox Events", retries = 3)
    ...
    private Mono<OrchestratorOutBoxEvent> markAsPublished(String refId, OrchestratorOutBoxEvent e) {
