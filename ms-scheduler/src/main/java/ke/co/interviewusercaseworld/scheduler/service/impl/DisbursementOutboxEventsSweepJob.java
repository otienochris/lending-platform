...
import ke.co.interviewusercaseworld.scheduler.repository.DisbursementOutBoxEventRepository;
...
public class DisbursementOutboxEventsSweepJob implements SweepJob {


    private final DisbursementOutBoxEventRepository outboxEventRepository;
    ...
    @Override
    @Job(name = "Disbursement Outbox Events", retries = 3)
    ...
    private Mono<DisbursementOutboxEvent> markAsPublished(String refId, DisbursementOutboxEvent e) {
